...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: onyx,
    gallery: [onyx, midnight, craft],
    description: "A solid black two-piece — for the long evenings of executive life.",
    story:
      "Black is the suit of last resort for most. For the executive, it is the uniform of the long night — board dinners, gala receptions, signatures past midnight. Cut from a deep, matte Vitale Barberis worsted that holds its line through the longest evening.",
    fabric: {
      composition: "100% Super 130s Wool",
      weight: "260 g/m²",
      mill: "Vitale Barberis Canonico — Biella, Italy",
      notes: "A dry, matte finish that absorbs candlelight without sheen.",
    },
    details: [
      "Half-canvassed construction",
      "Hand-padded peak lapels",
      "Single button closure",
      "Jetted hip pockets, no flap",
    ],
    sizes: ["46", "48", "50", "52", "54", "56"],
    fits: ["Tailored", "Slim"],
    lapels: ["Peak", "Notch"],
    linings: ["Onyx", "Bordeaux", "Azure"],
    monogram: true,
  },
  {
    id: "glen-director",
    ...
    description: "A glen check in charcoal and ink — pattern, restated for the corner office.",
    story:
      "The Prince of Wales check, redrawn at half-scale. From a distance, a quiet charcoal. Up close, a discreet glen — the kind of pattern that signals attention to the man who notices it.",
    fabric: {
      composition: "100% Super 140s Wool",
      weight: "255 g/m²",
      mill: "Holland & Sherry — Huddersfield, UK",
      notes: "A precision-woven check that aligns cleanly across every seam.",
    },
    details: [
      "Full-canvas construction",
      "Pattern-matched at lapel, pocket and seam",
      "Working surgeon's cuffs (4 buttons)",
      "Side adjusters, no belt loops",
    ],
    sizes: ["46", "48", "50", "52", "54", "56"],
    fits: ["Tailored", "Slim", "Classic"],
    lapels: ["Notch", "Peak"],
    linings: ["Charcoal", "Burgundy", "Azure"],
    monogram: true,
  },
  {
    id: "concorde-travel",
    name: "Concorde Travel",
    category: "Executive",
    fcfa: 1_350_000,
    usd: 2260,
    eur: 2100,
    image: midnight,
    gallery: [midnight, onyx, craft],
    description: "A high-twist navy — for the executive who measures distance in time zones.",
    story:
      "Cut from a Crispaire high-twist that resists the long-haul cabin and arrives unfolded at the meeting. The cloth recovers its shape between flights; the cut survives a week of hotels.",
    fabric: {
      composition: "100% High-Twist Wool",
      weight: "230 g/m²",
      mill: "Holland & Sherry — Huddersfield, UK",
      notes: "An open-weave, fresco-style cloth engineered for transcontinental travel.",
    },
    details: [
      "Half-canvassed construction",
      "Lightly structured shoulder",
      "Internal travel pocket, hand-stitched",
      "Pick-stitched edges, side vents",
    ],
    sizes: ["46", "48", "50", "52", "54", "56"],
    fits: ["Tailored", "Slim"],
    lapels: ["Notch"],
  ...
  },
  {
    ...
    image: onyx,
    gallery: [onyx, craft, midnight],
    description: "A textured charcoal — quiet authority with the weight of a winter morning.",
    story:
      "A donegal-flecked charcoal cut for the cold-season boardroom. The flecks are barely visible at three paces — the texture, however, is unmistakable in the hand.",
    fabric: {
      composition: "Wool-Cashmere blend (90/10)",
      weight: "310 g/m²",
      mill: "Drago — Biella, Italy",
      notes: "A heavier hand with a discreet flecked texture and exceptional drape.",
    },
    details: [
      "Full-canvas construction",
      "Hand-padded notch lapels",
      "Patch hip pockets, hand-stitched",
      "Working surgeon's cuffs",
    ],
    sizes: ["46", "48", "50", "52", "54", "56"],
    fits: ["Tailored", "Classic"],
    lapels: ["Notch", "Peak"],
    linings: ["Charcoal", "Burgundy", "Bone"],
    monogram: true,
  },
  {
    name: "Weekday Navy",
