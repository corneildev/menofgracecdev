...
=======
                <li
                  key={it.id}
                  className="flex gap-5 border-b border-hairline pb-8"
                >
                  <div className="w-20 h-24 bg-secondary shrink-0 overflow-hidden">
                    <img
                      src={it.image}
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-serif text-lg text-bone mb-1 truncate">
                      {it.name}
                    </h3>
>>>>>>> 9091cf2 (Initial commit of graceful-threads)
...
=======
                    ...
                    <div className="text-bone/80 text-sm font-light mb-3">
...
=======
              <span className="text-bone text-lg font-light">
                {formatFcfa(totalFcfa)}
              </span>
            </div>
            <div className="flex justify-end text-bone/50 text-xs mb-6">
              {formatUsd(totalUsd)}
            </div>
            <Link
              to="/checkout"
